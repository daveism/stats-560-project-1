...
blizzard_events_yale_chart <- ggScatter538fac2(blizzard_events_yale,blizzard_events_yale$personal,blizzard_events_yale$total_10,"Harm me","event_type",paste(source_yale,source_noaa,sep = " and "))
...
coastal_flood_yale_chart <- ggScatter538fac2(coastal_flood_yale,coastal_flood_yale$personal,coastal_flood_yale$total_10,"Harm me","event_type",paste(source_yale,source_noaa,sep = " and "))
...
drought_events_yale_chart <- ggScatter538fac2(drought_events_yale,drought_events_yale$personal,drought_events_yale$total_10,"Harm me","event_type",paste(source_yale,source_noaa,sep = " and "))
...
flash_events_yale_chart <- ggScatter538fac2(flash_events_yale,flash_events_yale$personal,flash_events_yale$total_10,"Harm me","event_type",paste(source_yale,source_noaa,sep = " and "))
...
flood_events_yale_chart <- ggScatter538fac2(flood_events_yale,flood_events_yale$personal,flood_events_yale$total_10,"Harm me","event_type",paste(source_yale,source_noaa,sep = " and "))
...
heat_events_county_yale_chart <- ggScatter538fac2(heat_events_county_yale,heat_events_county_yale$personal,heat_events_county_yale$total_10,"Harm me","event_type",paste(source_yale,source_noaa,sep = " and "))
...
tornado_events_county_yale_chart <- ggScatter538fac2(tornado_events_county_yale,tornado_events_county_yale$personal,tornado_events_county_yale$total_10,"Harm me","event_type",paste(source_yale,source_noaa,sep = " and "))
...
wildfire_events_yale_chart <- ggScatter538fac2(wildfire_events_yale,wildfire_events_yale$personal,wildfire_events_yale$total_10,"Harm me","event_type",paste(source_yale,source_noaa,sep = " and "))
...
mixall_believe_chart <- ggScatter538fac2(mix,mix$personal,mix$total_10,"Believe and","event_type", source_noaa)
ggsave("mixall_believe_chart.png", mixall_believe_chart, width=4, height=3)

mixall_harm_chart <- ggScatter538fac2(mix,mix$personal,mix$total_10,"Harm me and","event_type", source_noaa)
ggsave("mixall_harm_chart.png", mixall_harm_chart, width=4, height=3)

mixall_timing_chart <- ggScatter538fac2(mix,mix$timing,mix$total_10,"Harm Others and","event_type", source_noaa)
...
mixfew_believe_chart <- ggScatter538fac2(mixfew,mixfew$happening,mixfew$total_10,"Believe and","event_type", source_noaa)
ggsave("mixfew_believe_chart.png", mixfew_believe_chart, width=4, height=3)

mixfew_harm_chart <- ggScatter538fac2(mixfew,mixfew$personal,mixfew$total_10,"Harm me and","event_type", source_noaa)
ggsave("mixfew_harm_chart.png", mixfew_harm_chart, width=4, height=3)

mixfew_timing_chart <- ggScatter538fac2(mixfew,mixfew$timing,mixfew$total_10,"Harm others and","event_type", source_noaa)
